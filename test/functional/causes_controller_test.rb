...
class CausesControllerTest < ActionController::TestCase
  ...
  test "should create cause" do
    assert_difference('Cause.count') do
      post :create, cause: { creator: @cause.creator, dateCreated: @cause.dateCreated, description: @cause.description, name: @cause.name, tagline: @cause.tagline }
    end
  ...
  test "should update cause" do
    put :update, id: @cause, cause: { creator: @cause.creator, dateCreated: @cause.dateCreated, description: @cause.description, name: @cause.name, tagline: @cause.tagline }
    assert_redirected_to cause_path(assigns(:cause))
  end
